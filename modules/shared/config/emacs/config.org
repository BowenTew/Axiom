...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tetsuya"
    user-mail-address "1376490336@qq.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/moonshot/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/moonshot/bin" "/profile/bin" "/Users/moonshot/.npm-packages/bin" "/Users/moonshot/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
